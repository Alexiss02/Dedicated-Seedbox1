...
source <(wget -qO- https://raw.githubusercontent.com/Alexiss02/Seedbox-Components1/main/seedbox_installation.sh)
...
while getopts "u:p:c:q:l:rbvx3oh" opt; do
  case ${opt} in
	...
	h ) # process option help
		...
		source <(wget -qO- https://raw.githubusercontent.com/Alexiss02/Seedbox-Components1/main/Torrent%20Clients/qBittorrent/qBittorrent_install.sh)
		seperator
		info "Options:"
